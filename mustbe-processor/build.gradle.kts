...
ksp {
    arg("mustbe.package", "com.suleimanov.mustbe")
}
...
mavenPublishing {
    ...
    pom {
        name.set(pomData.versions.name.get() + " Processor")
        description.set("KSP processor for MustBe validation library.")
...
signing {
    useInMemoryPgpKeys(
        ...
        file("$rootDir/mustbe_private.asc").readText(),
